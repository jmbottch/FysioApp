...
namespace FysioApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        {
            var businessUser = await _business.Patient.Where(p => p.Email == Input.Email).FirstOrDefaultAsync();
            if (businessUser != null)
            {
                ...
                {
                    var user = new IdentityUser { Id = businessUser.Id, UserName = Input.Email, Email = Input.Email };
            ...
            {
                ModelState.AddModelError(string.Empty, "You must have had an Intake before you can Sign Up");
            }
